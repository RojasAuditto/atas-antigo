...
export function parseMovement(input: unknown): Movement {
  return movementSchema.parse(input);
}

export function parseMovements(input: unknown): Movement[] {
  return movementListSchema.parse(input);
}
